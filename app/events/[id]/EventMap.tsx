...
function CenterOnEvnet({ lat, lng }: { lat: number; lng: number }) {
    const map = useMap();
    useEffect(() => {
...
export default function EventMap({ lat, lng, name, description }: EventMapProps) {
